...
if __name__ == "__main__":
    ...
    expression_field = Entry(gui, textvariable=equation, width=15, font=('Courier' ,11, BOLD))
    ...
    plus = Button(gui, text=' + ', fg='white', bg='black',
                command=lambda: press("+"), height=2, width=14, font=('Courier' ,8, BOLD))
    ...
    equal = Button(gui, text=' = ', fg='white', bg='black',
                command=equalpress, height=2, width=14, font=('Courier' ,8, BOLD))
    equal.grid(row=5, column=2)
 
    clear = Button(gui, text='Clear', fg='white', bg='black',
                command=clear, height=2, width=14, font=('Courier' ,8, BOLD))
